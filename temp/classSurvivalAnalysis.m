...
%             end
        ...
        function SAobj=CalculateSurvivalCurve(SAobj)
            ...
            for k=1:num
                [SAobj.SurvivalTimeSorted{k,1}, SAobj.SurvivalCurve{k,1}, SAobj.CensorStatistics{k,1}, SAobj.SurvivalTimeTable{k,1}, SAobj.CumulativeHazard{k,1}]=KaplanMeierSurvivalCurve(SAobj.SurvivalTime{k},SAobj.flgCensor{k});
            end
        end
        ...
        function SAobj=CombineSurvivalTime(SAobj)
            ...
            [SAobj.SurvivalTimeCombined, SAobj.SurvivalCurveCombined, SAobj.CensorStatisticsCombined, SAobj.SurvivalTimeTableCombined, SAobj.CumulativeHazardCombined]=KaplanMeierSurvivalCurve(SAobj.SurvivalTimeCombined, FlagCensorCombined);
        end
...
function [SurvivalTimeSorted,SurvivalCurve,CensorStatistics,SurvivalTimeTable,CumulativeHazard]=KaplanMeierSurvivalCurve(SurvivalTime,flgCensor)
...
% sort data by survival time, and generate histogram table
    ...
    if any(flgCensor)
        CensorTimeTable=tabulate(SurvivalTimeTable(flgCensor)); CensorTimeTable(CensorTimeTable(:,2)==0,:)=[]; % SurvivalTimeTable - table of censors (the censor time)
    end
